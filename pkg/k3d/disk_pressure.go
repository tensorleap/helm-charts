...
func emitDiskPressureWarning() {
	...
	log.Warnf("If installation does not complete within a few minutes, consider increasing the disk space available to docker, and then retrying the installation.")
