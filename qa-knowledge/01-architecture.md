...
|---|---|---|
| web-ui | `tensorleap-web-ui:8080` | `public.ecr.aws/tensorleap/web-ui:master-c8508269` |
| node-server | `tensorleap-node-server:80` → pod `:4000` | `public.ecr.aws/tensorleap/node-server:master-63808c73` |
...
| engine / orchestrator / engine jobs | (no static svc; orchestrator is a Deployment) | `public.ecr.aws/tensorleap/engine:master-28b2652b` |
| engine-generics | (runtime Deployment) | `public.ecr.aws/tensorleap/engine-generic:master-28b2652b-py{38,39,310,311,312}` |
...
- `charts/tensorleap/Chart.yaml` `version` — a **minor** bump (`1.5.x → 1.6.0`)
  ...
  reinstall wipes the cluster). Current snapshot: tensorleap `1.6.71`, infra `1.1.8`.
